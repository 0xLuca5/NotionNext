...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '2f852c4ca1ae810ca902cc5fb0cbfec8,en:7c1d570661754c8fbc568e00a01fd70e',
  THEME: process.env.NEXT_PUBLIC_THEME || 'mythemes', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '0xLuca5', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '要么孤独,要么庸俗', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.lucas.hk.cn', // 网站地址
